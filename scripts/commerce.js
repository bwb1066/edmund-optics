...
const SITE_KEY = getMetadata('commerce-site') || 'eo-concept-3b';
const CATALOG_URL = getMetadata('commerce-catalog') || '/drafts/data/eo-catalog.json';
const COMMERCE_URL = getMetadata('commerce-url') || '';
...
if (typeof window !== 'undefined') {
  ...
  window.eoCommerce = store; // back-compat alias for EO-specific callers
