 ...
 * SYNCHRONOUSLY (so consumers such as the knowledge-content block always find a
 * callable `window.alloy`), configures it, then loads the library async to
 * drain the queue. Called from loadLazy before sections decorate.
 */
